      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div className="about-grid">
          ...
          <div>
            ...
            <p style={{ fontSize: 15, color: 'var(--color-body)', lineHeight: 1.8, marginBottom: 20 }}>
            ...
            <p style={{ fontSize: 15, color: 'var(--color-body)', lineHeight: 1.8 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            >
              ...
              <div style={{ fontWeight: 700, color: 'var(--color-muted)', fontSize: 13, marginTop: 12 }}>
            ...
            >
              {stats.map((stat) => (
                ...
                >
                  ...
                  <div style={{ fontWeight: 900, fontSize: 24, color: 'var(--color-accent)', lineHeight: 1 }}>
                    {stat.value}
                  </div>
                  <div style={{ fontSize: 11, color: 'var(--color-muted)', fontWeight: 600, marginTop: 4 }}>
                    {stat.label}
                  </div>
                </div>
              ))}
