    ...
    >
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        >
          {/* Brand */}
          <div>
            <div style={{ fontWeight: 800, fontSize: 20, color: '#EDD5B0', marginBottom: 6 }}>
              {shopInfo.name}
            </div>
            <div style={{ fontSize: 12, color: '#CC3A20', fontWeight: 600, marginBottom: 16, letterSpacing: '0.04em' }}>
              {shopInfo.tagline}
            </div>
            <p style={{ color: '#B89070', fontSize: 14, lineHeight: 1.7, margin: 0 }}>
          ...
          {/* Contact */}
          <div>
            <div style={{ fontWeight: 700, fontSize: 13, color: '#CC3A20', marginBottom: 18, letterSpacing: '0.08em' }}>
              CONTACT
            </div>
